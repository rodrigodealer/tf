...
resource "aws_instance" "default" {
  ...
  provisioner "file" {
    source      = "files/install_docker.sh"
  ...
  provisioner "file" {
    source      = "files/httpbin.service"
    destination = "/tmp/httpbin.service"
  ...
  provisioner "remote-exec" {
    inline = [
      "sudo cp /tmp/httpbin.service /etc/systemd/system/httpbin.service",
      "sudo sh /tmp/install_docker.sh",
      "sudo systemctl daemon-reload",
      "sudo systemctl restart httpbin",
    ]
